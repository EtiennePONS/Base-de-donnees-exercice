...
select t.num_trophee  from trophee t where t.date_prise between cast ('2052-05-01' as date) and cast ('2052-06-30'as date);
...
select r.nom_resserre, v.nom_village, r.superficie from resserre r
...
select v.nom_village, count(v.num_village)  from village v
